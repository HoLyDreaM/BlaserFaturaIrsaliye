...
{
    public partial class OtvliAlimIrsaliyesi : DevExpress.XtraEditors.XtraForm
    {
        public OtvliAlimIrsaliyesi()
        {
            InitializeComponent();
        }
        ...
        int CarpKontrol = 0;
        decimal NetOtvTutarimiz = 0;

        Ayarlar.LookUpKayitliAlimIrsaliyeleri frmKayitliAlimIrsaliyeleri;
        Ayarlar.LookUpStokVeCariHareketleriAlimIrsaliye frmLookUpStokVeCariHareketleri;
        Ayarlar.KayitliAlimSiparisleri frmKayitliSiparisler;
        Ayarlar.LookUpAlimIrsaliyesiMalKodu frmAlimIrsaliyesiMalKodu;
        FiyatListesi.frmFiyatListeleriAlimIrsaliyeleri frmfiyatlarimiz;
        ...
        {
            frmLookUpStokVeCariHareketleri = new Ayarlar.LookUpStokVeCariHareketleriAlimIrsaliye();
            frmLookUpStokVeCariHareketleri.frmOtvliAlimIrsaliyesi = this;
        ...
        private void OtvliAlımIrsaliyesi_Load(object sender, EventArgs e)
        {
            try
            {
                ps_yenSatirEkle();

                raporListele(Application.StartupPath + @"\Raporlar\Alim İrsaliye\");
            ...
            try
            {
                ...
                this.tblLookUpStokKartlariTableAdapter.lookUpStokKartlari(this.dataSet1.tblLookUpStokKartlari, "01");
        ...
        private void ps_kolonlarıOku_Kaydet(islemTipi islemTipi)
        {
            try
            {
                ...
                {
                    grdOtvliSatisIrsaliyesi.MainView.RestoreLayoutFromXml(Application.StartupPath + "\\KullaniciAyarlari\\" + ID + "_OtvAlimIrsaliye.xml");
                }
                else if (islemTipi == islemTipi.kaydet)
                {
                    grdOtvliSatisIrsaliyesi.MainView.SaveLayoutToXml(Application.StartupPath + "\\KullaniciAyarlari\\" + ID + "_OtvAlimIrsaliye.xml");
                    ps_kolonlarıOku_Kaydet(OtvliAlimIrsaliyesi.islemTipi.oku);
                }
            }
            catch { }
        }
        ...
        #region Sipariş No Properties

        private void txtSiparisNo_Properties_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            frmKayitliSiparisler = new Ayarlar.KayitliAlimSiparisleri();
            frmKayitliSiparisler.frmOtvliAlimIrsaliyesi = this;
        ...
        #region Irsaliye Ön Değerleri Tarafı
        ...
        #region Kayıtlı Irsaliye ve Sipariş Ön Değerleri
        ...
        {
            this.tblEskiKayitliSiparisDegerleriTableAdapter.Fill(this.dataSet2.tblEskiKayitliSiparisDegerleri, SiparisNumber);
            ...
            if (DovizDurum == true && Dovizislemi == "Bol")
            {
                ...
                if (Convert.ToInt32(txtDovizMalBedeli.EditValue) < 1)
                {
                    foreach (DataRow dr in dataSet2.tblStk005Irsaliye.Rows)
                    {
                        ...
                        for (int i = 0; i < dataSet2.tblStk005Irsaliye.Rows.Count - 1; i++)
                        {
                            string SatirTipiAliyoruz = dataSet2.tblStk005Irsaliye.Rows[i][colSatirTipi.FieldName].ToString();

                            if (SatirTipiAliyoruz == "T")
                            {
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_DovizTutari.FieldName] = malBedeli;
                            }
                            else if (SatirTipiAliyoruz == "I")
                            {
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_DovizTutari.FieldName] = iskonto;
                            }
                            else if (SatirTipiAliyoruz == "N")
                            {
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_DovizTutari.FieldName] = malBedeli - iskonto;
                            }
                            else if (SatirTipiAliyoruz == "K")
                            {
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_DovizTutari.FieldName] = KdvDipSatir;
                            }
                            else if (SatirTipiAliyoruz == "G")
                            {
                                decimal NetTutarimiz = malBedeli - iskonto;
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_DovizTutari.FieldName] = (malBedeli - iskonto) + KdvDipSatir;
                            }
                        }
                    }
                }
                else
                {
                    foreach (DataRow dr in dataSet2.tblStk005Irsaliye.Rows)
                    {
                        ...
                        for (int i = 0; i < dataSet2.tblStk005Irsaliye.Rows.Count - 1; i++)
                        {
                            ...
                            if (SatirTipiAliyoruz == "T")
                            {
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_Tutari.FieldName] = malBedeli;
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_DovizTutari.FieldName] = YeniDovizMalBedelimiz;
                            }
                            else if (SatirTipiAliyoruz == "I")
                            {
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_Tutari.FieldName] = iskonto;
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_DovizTutari.FieldName] = DovizIskontomuz;
                            }
                            else if (SatirTipiAliyoruz == "N")
                            {
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_Tutari.FieldName] = malBedeli - iskonto;
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_DovizTutari.FieldName] = YeniDovizMalBedelimiz - iskdovizli;
                            }
                            else if (SatirTipiAliyoruz == "K")
                            {
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_Tutari.FieldName] = KdvDipSatir2;
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_DovizTutari.FieldName] = KdvDipSatir;
                            }
                            else if (SatirTipiAliyoruz == "U")
                            {
                                decimal NetTutarimiz = malBedeli - iskonto;
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_Tutari.FieldName] = NetTutarimiz + NetOtvTutarimiz;
                            }
                            else if (SatirTipiAliyoruz == "G")
                            {
                                decimal NetTutarimiz = malBedeli - iskonto;
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_Tutari.FieldName] = NetTutarimiz + NetOtvTutarimiz + KdvDipSatir2;
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_DovizTutari.FieldName] = KdvDipSatir + (YeniDovizMalBedelimiz - iskdovizli);
                            }
                        }
                    }
                }
                ...
                if (DovizDurum == true && Dovizislemi == "Carp")
                {
                    ...
                    foreach (DataRow dr in dataSet2.tblStk005Irsaliye.Rows)
                    {
                        ...
                        for (int i = 0; i < dataSet2.tblStk005Irsaliye.Rows.Count - 1; i++)
                        {
                            ...
                            {
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_Tutari.FieldName] = malBedeli;
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_DovizTutari.FieldName] = DovizToplamTutar2;
                            }
                            else if (SatirTipiAliyoruz == "I")
                            {
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_Tutari.FieldName] = iskonto;
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_DovizTutari.FieldName] = iskdovizli;
                            }
                            else if (SatirTipiAliyoruz == "N")
                            {
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_Tutari.FieldName] = malBedeli - iskonto;
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_DovizTutari.FieldName] = DovizToplamTutar2 - iskdovizli;
                            }
                            else if (SatirTipiAliyoruz == "K")
                            {
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_Tutari.FieldName] = KdvDipSatir;
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_DovizTutari.FieldName] = KdvDipSatir2;
                            }
                            else if (SatirTipiAliyoruz == "U")
                            {
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_Tutari.FieldName] = (malBedeli - iskonto) + NetOtvTutarimiz;
                            }
                            else if (SatirTipiAliyoruz == "G")
                            {
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_Tutari.FieldName] = ((malBedeli - iskonto) + NetOtvTutarimiz) + KdvDipSatir;
                                dataSet2.tblStk005Irsaliye.Rows[i][colSTK005_DovizTutari.FieldName] = KdvDipSatir2 + (DovizToplamTutar2 - iskdovizli);
                            }
                        }
                    }
                }
        ...
        private void txtHesapKodu_Closed(object sender, DevExpress.XtraEditors.Controls.ClosedEventArgs e)
        {
            try
            {
                ...
                {
                    dovizKurumuz = (decimal)this.evrakNoSeriTableAdapter1.DovizKuru(DovizHesapKodumuz, DovizParaBirimimiz);
                    //frmAlimIrsaliyesiMalKodu.dovizKurumuz = dovizKurumuz;
                }
                else
                {
                    dovizKurumuz = Convert.ToDecimal(dr[16].ToString());
        ...
        #region Grid Kolonları Kaydediyoruz
        ...
        private void GridLookUpMalKodu_Closed(object sender, DevExpress.XtraEditors.Controls.ClosedEventArgs e)
        {
            try
            {
        ...
        private void GridLookUpMalAdi_Closed(object sender, DevExpress.XtraEditors.Controls.ClosedEventArgs e)
        {
            try
            {
        ...
        private void GridLookUpSeriNo_Popup(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(dr[0].ToString()))
                {
                    ...
                    foreach (DataRow dRow in dataSet1.tblLookUpStokMiktarlari.Rows)
                    {
                ...
                {
                    this.dataSet1.tblLookUpStokMiktarlari.Clear();
                }
            }
        ...
        private void GridLookUpSeriNo_Closed(object sender, DevExpress.XtraEditors.Controls.ClosedEventArgs e)
        {
            try
            {
                decimal miktar = 0;
        ...
        private void GridLookUpKdvOrani_Closed(object sender, DevExpress.XtraEditors.Controls.ClosedEventArgs e)
        {
            int flag = 0;
        ...
        #region Kaydet,Sil ve Yeni Butonu
                ...
                if (!string.IsNullOrEmpty(txtIrsaliyeNo.Text) && !string.IsNullOrEmpty(txtIrsaliyeNo.Text))
                {
                    ...
                    if (this.evrakNoSeriTableAdapter1.EvrakNoKontrol(txtIrsaliyeSeri.Text + txtIrsaliyeNo.Text) == 0)
                    {
                        ...
                        else
                        {
                            ...
                            this.evrakNoSeriTableAdapter1.BlaserEvrakKaydet(txtIrsaliyeSeri.Text, Convert.ToInt32(txtIrsaliyeNo.Text), 3);
        ...
        #region Irsaliye Kaydediyoruz ve Evrak No yu Çağırıyoruz
        ...
        private void ps_IrsaliyeKaydet()
        {
            try
            {
                ...
                foreach (DataRow dr in dataSet2.tblStk005Irsaliye.Rows)
                {
                    ...
                    {
                        MessageBox.Show("Hesap Kodu Seçmediniz.Lütfen Kontrol Edip Tekrar Deneyin");
                        return;
                    }
                    ...
                    //Insert Yapıyoruz
                    this.evrakNoSeriTableAdapter1.STK005AlimislemiEkle(StokMalKodu, IslemTarihi, CariHesapKodu, EvrakSeriNumarasi, Miktari, BirimFiyati, Tutari,
                    ...
                    if (PcAdi.ToString().Length > 5)
                    {
                        PcAdi = PcAdi.ToString().Substring(0, 5);
                    }

                    try
                    {

                        this.evrakNoSeriTableAdapter1.StokKartiGuncelleAlimislemi((decimal)Miktari,Miktar2, Tutari,(decimal)DovizTutari, GirenTarih, GirenSaat, PcAdi, StokMalKodu);
                    }
                    catch (Exception ex)
                    {
        ...
        private void ps_linkeCariHareketleriKaydet()
        {
            ...
            foreach (DataRow dr in dataSet2.tblStk005Irsaliye.Rows)
            {
                ...
                {
                    this.evrakNoSeriTableAdapter1.CariHareketEkle(18,//Z
                         IrsaliyeFaturaTarihi, txtIrsaliyeSeri.Text + txtIrsaliyeNo.Text, "A", 4, "A", kayitSayisi++, "",
                         dr[colSTK004_Aciklama.FieldName].ToString().Substring(0, 1),
                         dr[colSTK004_Aciklama.FieldName].ToString().Substring(1, dr[colSTK004_Aciklama.FieldName].ToString().Length - 1), txtHesapKodu.Text, 0, 0);
                }
            }

            foreach (DataRow dr in dataSet2.tblStk005Irsaliye.Rows)
            {
                if (dr[colSatirTipi.FieldName].ToString() == "Z")
                {
                    this.evrakNoSeriTableAdapter1.CariHareketEkle(18,//Z
                         IrsaliyeFaturaTarihi, txtIrsaliyeSeri.Text + txtIrsaliyeNo.Text, "A", 4, "Z", kayitSayisi++, "", "1", "", txtHesapKodu.Text, 0, 0);
                }
                if (dr[colSatirTipi.FieldName].ToString() == "T")
                {
                    this.evrakNoSeriTableAdapter1.CariHareketEkle(18,//T
                         IrsaliyeFaturaTarihi, txtIrsaliyeSeri.Text + txtIrsaliyeNo.Text, "A", 4, "T", kayitSayisi++, "", "1", dr[colSTK004_Aciklama.FieldName].ToString(), txtHesapKodu.Text, Convert.ToDecimal(txtMalBedeli.EditValue), 0);
                }
                if (dr[colSatirTipi.FieldName].ToString() == "I")
                {
                    this.evrakNoSeriTableAdapter1.CariHareketEkle(18,//I
                         IrsaliyeFaturaTarihi, txtIrsaliyeSeri.Text + txtIrsaliyeNo.Text, "A", 4, "I", kayitSayisi++, "", "1", dr[colSTK004_Aciklama.FieldName].ToString(), txtHesapKodu.Text, Convert.ToDecimal(txtIskonto.EditValue), 0);
                }
                if (dr[colSatirTipi.FieldName].ToString() == "N")
                {
                    this.evrakNoSeriTableAdapter1.CariHareketEkle(18,//N
                         IrsaliyeFaturaTarihi, txtIrsaliyeSeri.Text + txtIrsaliyeNo.Text, "A", 4, "N", kayitSayisi++, "", "1", dr[colSTK004_Aciklama.FieldName].ToString(), txtHesapKodu.Text, Convert.ToDecimal(txtNetTutar.EditValue), 0);
                }
                if (dr[colSatirTipi.FieldName].ToString() == "O")
                {
                    this.evrakNoSeriTableAdapter1.CariHareketEkle(18,//O
                         IrsaliyeFaturaTarihi, txtIrsaliyeSeri.Text + txtIrsaliyeNo.Text, "A", 4, "O", kayitSayisi++, "", "1", dr[colSTK004_Aciklama.FieldName].ToString(), txtHesapKodu.Text, Convert.ToDecimal(txtOtv.EditValue), 0);
                }
                if (dr[colSatirTipi.FieldName].ToString() == "U")
                {
                    this.evrakNoSeriTableAdapter1.CariHareketEkle(18,//U
                         IrsaliyeFaturaTarihi, txtIrsaliyeSeri.Text + txtIrsaliyeNo.Text, "A", 4, "U", kayitSayisi++, "", "1", dr[colSTK004_Aciklama.FieldName].ToString(), txtHesapKodu.Text, Convert.ToDecimal(txtKdvMatrahi.EditValue), 0);
                }
                if (dr[colSatirTipi.FieldName].ToString() == "K")
                {
                    this.evrakNoSeriTableAdapter1.CariHareketEkle(18,//K
                         IrsaliyeFaturaTarihi, txtIrsaliyeSeri.Text + txtIrsaliyeNo.Text, "A", 4, "K", kayitSayisi++, "", "1", dr[colSTK004_Aciklama.FieldName].ToString(), txtHesapKodu.Text, Convert.ToDecimal(txtKdv.EditValue), 0);
                }
                if (dr[colSatirTipi.FieldName].ToString() == "G")
                {
                    this.evrakNoSeriTableAdapter1.CariHareketEkle(18,//K
                          IrsaliyeFaturaTarihi, txtIrsaliyeSeri.Text + txtIrsaliyeNo.Text, "A", 4, "G", kayitSayisi++, "", "1", dr[colSTK004_Aciklama.FieldName].ToString(), txtHesapKodu.Text, Convert.ToDecimal(txtGenelToplam.EditValue), 0);
                }
                if (dr[colSatirTipi.FieldName].ToString() == "Y")
                {
                    this.evrakNoSeriTableAdapter1.CariHareketEkle(18,//Z
                         IrsaliyeFaturaTarihi, txtIrsaliyeSeri.Text + txtIrsaliyeNo.Text, "A", 4, "Y", kayitSayisi++, "", "1", "", txtHesapKodu.Text, 0, 0);
                }
            }
        }
        ...
        {
            txtIrsaliyeSeri.Text = this.evrakNoSeriTableAdapter1.BlaserEvrakSeri(3).ToString();

            int evrakNo = (int)this.evrakNoSeriTableAdapter1.BlaserEvrakNo(3);//3 Alım Irsaliyesi
        ...
        #region Irsaliye No Properties

        private void txtIrsaliyeNo_Properties_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            frmKayitliAlimIrsaliyeleri = new Ayarlar.LookUpKayitliAlimIrsaliyeleri();
            frmKayitliAlimIrsaliyeleri.frmOtvliAlimIrsaliyeleri = this;
            frmKayitliAlimIrsaliyeleri.Owner = this;
            frmKayitliAlimIrsaliyeleri.ShowDialog();
        }

        #endregion

        #region Klavye Kısa Yol Tuş Atamaları

        private void OtvliAlimIrsaliyesi_KeyDown(object sender, KeyEventArgs e)
        {
            #region enter geçiş
            ...
            try
            {
                if (cmbFaturalar.SelectedIndex == -1 || string.IsNullOrEmpty(cmbFaturalar.SelectedItem.ToString()))
                    ...
                    if (!string.IsNullOrEmpty(txtHesapKodu.Text) || !string.IsNullOrEmpty(txtIrsaliyeSeri.Text + txtIrsaliyeNo.Text))
                    {
                        ...
                        report1.Load(Application.StartupPath + @"\Raporlar\Alim İrsaliye\" + cmbFaturalar.SelectedItem.ToString());
        ...
        private void btnPnSiparisGetir_Click(object sender, EventArgs e)
        {
            ...
            {
                tblCtrlESiplerTableAdapter.CtrlEAlimIrsaliyesiSipler(dataSet2.tblCtrlESipler, txtHesapKodu.Text);
            ...
            else
            {
                ...
                tblCtrlESiplerTableAdapter.CtrlEAlimIrsaliyesiTarihliSipler(dataSet2.tblCtrlESipler, txtHesapKodu.Text, TarihliSorgu);
        ...
        private void repositoryBtnMalAdi_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            if (satirTipiTextBox.Text == "M")
            {
                ...
                frmAlimIrsaliyesiMalKodu = new Ayarlar.LookUpAlimIrsaliyesiMalKodu();
                frmAlimIrsaliyesiMalKodu.frmOtvliAlimIrsaliyesi = this;
                frmAlimIrsaliyesiMalKodu.Owner = this;
                frmAlimIrsaliyesiMalKodu.Birim = FiyatID;
                frmAlimIrsaliyesiMalKodu.HesapKodu = txtHesapKodu.Text;
                frmAlimIrsaliyesiMalKodu.ListeAdi = txtListeAdi.Text;
                frmAlimIrsaliyesiMalKodu.ListeNo = txtListeNo.Text;
                frmAlimIrsaliyesiMalKodu.Tarih = GirenTarih;
                frmAlimIrsaliyesiMalKodu.SatirNumarasi = numarasatir;
                frmAlimIrsaliyesiMalKodu.ShowDialog();
        ...
        {
            frmfiyatlarimiz = new FiyatListesi.frmFiyatListeleriAlimIrsaliyeleri();
            frmfiyatlarimiz.frmOtvliAlimIrsaliyesi = this;
